function TFMat = PlotTFMap_All_Return(kappaMat)

[AxisTime, AxisFreq, nTime, nFreq] = GetAxisBands;
[RngMatSeg, nBandSeg] = GetSegmentBands;
[RngMatFreq, nBandFreq] = GetFreqBands;
...
%     imagesc(0:0.5:4, 6:2:34, TFMat{i}(2:end-1, :));set(gca,'ydir','normal'); 
